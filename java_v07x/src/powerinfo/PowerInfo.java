...
// NOTE FROM VERSION V0.55 USE JDK7 MODE.
// NOTE FROM VERSION V0.70 REDESIGNED.
...
// v0.77 : BUG FIX: Java line separator = 2 chars.
...
private static long timestamp;      // timestamp for drawings = f(time)
...
//---------- Setup variables and GUI options -----------------------------------
    ...
    timestamp = 0;      // revisual timer ticks count, not used yet
...
//--- changes v0.75 ---
//  vp2.getCombo().addItem(batPath);                 // Set value for combo
    for( int i=0; i<np;  i++ )
        {
...
// Note ACselect, BATselect not used yet (v0.72), works this listener
...
//---------- Add listeners for checkboxes, with built array --------------------
...
//---------- Built result of windows-specific branch ---------------------------    
...
//========== LINUX BRANCH ======================================================
    ...
    String batPath = "/sys/class/power_supply/BAT0";   // Linux Path for BAT
...
//---------- Built result of linux-specific branch -----------------------------
// Create array of panels for visual and array of table models for report,
// plus special pool for dynamical revisual
