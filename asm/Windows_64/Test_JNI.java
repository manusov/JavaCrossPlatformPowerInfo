...
//static JNIGATE jt;
   public static void main(String[] args)
   {
	...
	long[] IPB = new long[4096]; for (int i=0; i<4096; i++) { IPB[i]=0; }
	long[] OPB = new long[4096]; for (int i=0; i<4096; i++) { OPB[i]=0; }
	IPB[0]=3;
	
	// int c = jt.NativeAgent( IPB, OPB, 4096, 4096 );
	// int c = jt.NativeAgent( null, OPB, 0, 4096 );
...
/*
	...
	a = OPB[5];
	a1 = a & a2; System.out.println(a1);
	a1 = ( a >> 32 ) & 0xFFFF; System.out.println(a1);
	a1 = ( a >> 48 ) & 0xFFFF; System.out.printf("%04Xh\n",a1);
*/
