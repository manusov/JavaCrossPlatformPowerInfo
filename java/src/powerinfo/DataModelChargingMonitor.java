...
Note. 
"Current level" can be interpreted as I-parameter (electrical current),
use "Actual level" instead.
*/
...
private final String nameY1mWh = "Actual level, mWh" ,
                     nameY1RU  = "Actual level, relative ratio units";

private final String nameX2 = nameX1;

private final String nameY2mWh = "Actual rate, mW" ,
                     nameY2RU  = "Actual rate, relative ratio units";

private final double dataY1[], dataY2[];
private final int nX;
private int mX;
private boolean powerUnits = false;

// Constructor initialize 2 arrays (actual level, actual rate)
// accept size
...
// Get X,Y names for 2 graphs: actual level, actual rate
...
// Reserved for write array for first graph (actual level, mWh)
public void setDataY1(double a)  
    {
    // reserved
    }

// Reserved for write array for second graph (actual rate, mW)
...
// for first graph: actual capacity level, mWh
...
// Push one value to graph array, normally called by timer tick
// for second graph: actual power rate, mW
